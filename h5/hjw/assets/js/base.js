...
var aigangjingye = { //敢于担当
    ...
    videoText: '',
    content: [
        { img: imgs.c11, title: "郝井文驾机参加对抗空战演练（2018年7月20日摄）" },
        ...
        { img: imgs.c12, title: "郝井文（右）给新飞行员复盘讲解飞行训练过程（2018年6月23日摄）" },
...
var yongyuchuangxin = { //善于作为
    ...
    content: [
        ...
        { img: imgs.c21, title: "郝井文训练归来（2018年6月23日摄）" },
        ...
        { img: imgs.c22, title: "郝井文带领歼击机编队参加空军体系远洋训练（资料照片）" },
...
var ganyufengxian = { //一心为民
    ...
    videoText: '',
    content: [
        { img: imgs.c31, title: "郝井文准备升空训练（2018年12月14日摄）" },
        ...
        { img: imgs.c32, title: "郝井文第一个架次升空执行警巡任务（2018年5月3日摄）" },
